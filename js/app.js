...
function validarFormulario (e) {
    ...
    if(terminoBusqueda === '') {
        mostrarAlerta('Agrega termino búsqueda');
        return;
    }
...
function buscarImagenes() {
    ...
    const key = '28235873-79e06012564575a4856cbb4ff';
...
// Generador que registra la cantidad de elementos de cuedo a las páginas
